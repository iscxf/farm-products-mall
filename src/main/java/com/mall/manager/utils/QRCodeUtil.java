...
public class QRCodeUtil {
    ...
    public static void encode(String content, String imgPath, String destPath, String fileName, boolean needCompress) throws Exception {
        ...
        mkdirs(destPath);
        if (destPath.contains("ftp:")){
            URL url = new URL( destPath + fileName + ".jpg");
            BufferedOutputStream bw = new BufferedOutputStream(url.openConnection().getOutputStream());
            ImageIO.write(image, FORMAT_NAME, bw);
            bw.flush();
            bw.close();
            return;
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        //生成带logo 的二维码
        String text = "http://www.iscxf.com";
        QRCodeUtil.encode(text, logoPath, "C:\\Users\\CXF\\Desktop\\工具", "dddddd", true);

        //生成不带logo 的二维码
        String textt = "http://www.baidu.com";
//        QRCodeUtil.encode(textt,"","C:\\Users\\CXF\\Desktop\\工具","dd2",true);
